 ...
 *  @author     your name
 *  @package    Yjs
 *  @version    $Id: app.controller.php,v 1.10 2005/03/01 14:34:42 fujimoto Exp $
 */
...
include_once('Yjs_Error.php');
require_once('Yjs_QueryManager.php');

/**
 *  Yjsアプリケーションのコントローラ定義
 *
 *  @author     your name
 *  @access     public
 *  @package    Yjs
 */
class Yjs_Controller extends Ethna_Controller
{
    /**#@+
     *  @access private
     */
