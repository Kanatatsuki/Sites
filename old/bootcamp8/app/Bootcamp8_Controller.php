...
require_once 'Bootcamp8_Error.php';
require_once 'Bootcamp8_ActionClass.php';
require_once 'Bootcamp8_ActionForm.php';
require_once 'Bootcamp8_ViewClass.php';

/**
 *  Bootcamp8 application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Bootcamp8
 */
class Bootcamp8_Controller extends Ethna_Controller
{
    /**#@+
     *  @access private
     */
    ...
    var $forward = array(
         ...
         *
         *  'index'         => array(
         *      'view_name' => 'Bootcamp8_View_Index',
         *  ),
         */
    );
    ...
    var $class = array(
        ...
        'form'          => 'Bootcamp8_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'sql'           => 'Ethna_AppSQL',
        'view'          => 'Bootcamp8_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Bootcamp8_UrlHandler',
    );
    ...
    var $plugin_search_appids = array(
         ...
         *  2. Bootcamp8_Plugin_Foo_Bar
         *  3. Ethna_Plugin_Foo_Bar
         *
         *  'Common', 'Bootcamp8', 'Ethna',
         */
        'Bootcamp8', 'Ethna',
    );
